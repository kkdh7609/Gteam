...
class SettingUser extends StatefulWidget {
  SettingUser(
      {Key key, this.onSignedOut, this.userDocID, this.changeInfoStatus})
      : super(key: key);
...
class _SettingUserState extends State<SettingUser> {
  ...
  String _phoneValidator(String value){
    ...
    if(!regex.hasMatch(value))
      return '123-456-789 형태로 입력해 주십시오';
    else
      return null;
  }
        ...
        body: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              if(!_checkedGender) {
                ...
                _selectedGender = (this._userData.gender == null) ? Gender.FEMALE : Gender.MALE;
                _checkedGender = true;
              }
