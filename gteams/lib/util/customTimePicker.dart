...
class _CustomTimePickerDialogState extends State<_CustomTimePickerDialog> {
  ...
  void initState() {
    ...
    if(widget.initialTime.minute > 30){
      hour = (hour < 23 ? hour + 1 : 0);
      minute = 0;
    }
    else if(widget.initialTime.minute < 30 && widget.initialTime.minute > 0){
    minute = 30;
    }
...
Future<TimeOfDay> showCustomTimePicker({
  ...
  final Widget dialog = _CustomTimePickerDialog(initialTime: initialTime);
