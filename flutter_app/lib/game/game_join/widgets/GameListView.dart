                                                                        ...
                                                                        children: <
                                                                          ...
                                                                          Padding(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: <Widget>[
                                                                                  ...
                                                                                  SizedBox(height: 5),
                                                                                  Text("옷 대여", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.black.withOpacity(0.7), fontFamily: 'Dosis')),
                                                                                ],
                                                                              )),
                                                                          SizedBox(
                                                                              width: 20),
                                                                          Column(
                                                                            ...
                                                                            children: <Widget>[
                                                                              ...
                                                                              SizedBox(height: 5),
                                                                              Text("신발 대여", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.black.withOpacity(0.7), fontFamily: 'Dosis')),
                                                                            ],
                                                                          ),
                                                                          SizedBox(
                                                                              width: 20),
                                                                          Column(
                                                                            ...
                                                                            children: <Widget>[
                                                                              ...
                                                                              SizedBox(height: 5),
                                                                              Text("주차장", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.black.withOpacity(0.7), fontFamily: 'Dosis')),
                                                                            ],
                                                                          ),
                                                                          SizedBox(
                                                                              width: 20),
                                                                          Column(
                                                                            ...
                                                                            children: <Widget>[
                                                                              ...
                                                                              SizedBox(height: 5),
                                                                              Text("샤워실 이용", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.black.withOpacity(0.7), fontFamily: 'Dosis')),
                                                                            ],
                                                                          ),
                                                                          SizedBox(
                                                                              width: 20),
